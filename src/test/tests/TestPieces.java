...
/*
    ...
    public void initTestBoard() {
        Constants.getInstance().setGameSpeed(1);
        testBoard = new Board(8, 10);
    }

    @Test
    public void placeJ() {
        Piece j = new JPiece(testBoard,3, 0);
        testBoard.placePiece(j);
